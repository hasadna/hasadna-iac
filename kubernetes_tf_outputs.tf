  ...
  tf_outputs_data = merge(
    {
      ...
      ingress-leafy-webapp = module.hasadna.cloudflare_records_rke2_ingress_cnames["leafy"].hostname,
      ingress-dear-diary-webapp = module.hasadna.cloudflare_records_rke2_ingress_cnames["dear-diary"].hostname,
      ingress-open-pension-ng-webapp = module.hasadna.cloudflare_records_rke2_ingress_cnames["open-pension-ng"].hostname,
      ingress-open-law-archive-webapp = module.hasadna.cloudflare_records_rke2_ingress_cnames["open-law-archive"].hostname,
